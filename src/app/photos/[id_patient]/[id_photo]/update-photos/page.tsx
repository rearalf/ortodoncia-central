...
function UpdatePhotosPage({ params }: { params: { id_patient: string; id_photo: string } }) {
	const {
		links,
		images,
		loading,
		...
		handleCancelButton,
		handleOnChangeInput,
	} = useUpdatePhotosPage(params.id_patient, params.id_photo)
	return (
		<>
			...
			<main className={styles.main}>
				...
				<h1 className={styles.title}>Modificar fotos e imagenes</h1>
